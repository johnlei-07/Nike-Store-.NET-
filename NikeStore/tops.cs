...
namespace NikeStore
{
    public partial class tops : Form
    {
        ...
        private void tops_Load(object sender, EventArgs e)
        {
            ...
            {
                Price = 1399,
                ProductName = "1.Corbyn Nike T-shirt",
                Category = "Tops",
            });
            comboBox1.Items.Add(new ProductList()
            {
                Price = 1699,
                ProductName = "2.Nike Swoosh T-shirt",
                Category = "Tops",
            });
            comboBox1.Items.Add(new ProductList()
            {
                Price = 1299,
                ProductName = "3.Nike Men's Soccer",
                Category = "Tops",
            });
            comboBox1.Items.Add(new ProductList()
            {
                Price = 1399,
                ProductName = "4.Nike Men's Football",
                Category = "Tops",
            });
            comboBox1.Items.Add(new ProductList()
            {
                Price = 1700,
                ProductName = "5.Nike Men's USMT T-shirt",
                Category = "Tops",
            });
            comboBox1.Items.Add(new ProductList()
            {
                Price = 2199,
                ProductName = "6.USA Legend Nike T-shirt",
                Category = "Tops",
            });
            comboBox1.Items.Add(new ProductList()
            {
                Price = 1499,
                ProductName = "7.Nike Men's SB T-shirt",
                Category = "Tops",
            });
            comboBox1.Items.Add(new ProductList()
            {
                Price = 2499,
                ProductName = "8.Nike 4-Star T-shirt",
                Category = "Tops",
            });
        ...
        private void dgv_Orders_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
