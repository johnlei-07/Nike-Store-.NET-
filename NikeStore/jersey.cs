...
namespace NikeStore
{
    public partial class jersey : Form
    {
        ...
        private void jersey_Load(object sender, EventArgs e)
        {
            ...
            {
                Price = 2799,
                ProductName = "1.Lebron Lakers Jersey",
                Category = "Jersey",
            });
            comboBox1.Items.Add(new ProductList()
            {
                Price = 2299,
                ProductName = "2.DWade Heat Lakers",
                Category = "Jersey",
            });
            comboBox1.Items.Add(new ProductList()
            {
                Price = 2199,
                ProductName = "3.KD Suns Jersey",
                Category = "Jersey",
            });
            comboBox1.Items.Add(new ProductList()
            {
                Price = 1999,
                ProductName = "4.JA Memphis Jersey",
                Category = "Jersey",
            });
            comboBox1.Items.Add(new ProductList()
            {
                Price = 1900,
                ProductName = "5.JT Boston Jersey",
                Category = "Jersey",
            });
            comboBox1.Items.Add(new ProductList()
            {
                Price = 2699,
                ProductName = "6.Jordan Bulls Jersey",
                Category = "Jersey",
            });
            comboBox1.Items.Add(new ProductList()
            {
                Price = 2199,
                ProductName = "7.AD Lakers Jersey",
                Category = "Jersey",
            });
            comboBox1.Items.Add(new ProductList()
            {
                Price = 1899,
                ProductName = "8.AE Wolves Lakers",
                Category = "Jersey",
            });
